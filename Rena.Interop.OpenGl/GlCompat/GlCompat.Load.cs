...
public unsafe partial class GlCompat
{
    ...
    public GlCompat(delegate* unmanaged<byte*, void*> loadFunc)
    {
        ...
        if(Version10)
        {
            ...
            fixed(byte* name = "glMapGrid2f"u8)
        ...
        if(Version45)
        {
            ...
            fixed(byte* name = "glGetnSeparableFilter"u8)
            ...
            fixed(byte* name = "glGetnHistogram"u8)
            ...
            fixed(byte* name = "glGetnMinmax"u8)
